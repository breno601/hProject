...
cuia_url = "http://localhost:65401/api/"
epicampaign_url = "https://api.campaign.episerver.net/rest/226263180570/"

headers_cuia = {"Content-type": "application/json", "ApiKey": "eY2adMWzVKTeg2N9zgaga.oTu7xqgDoCyxQbJDeHkugohAiBiK"}
headers_epicampaign = {"Content-type": "application/json", "Authorization": "Basic dGFyaWsua2lsaWNAYmVlcnd1bGYuY29tOlB0OFAhaE8wblp2QC5hcGkucHVycG9zZXMhY2FtcGFpZ24jYncyMDE4"}


def get_subscribers_batch(recipient_list_id, row, status, batch_size):
    subscribers_path = epicampaign_url + "recipients/" + recipient_list_id + "?" + "offset=" + row + "&" + "limit=" + batch_size + "&" + "attributeNames=firstname%2Clastname%2Cmarket_code%2Clanguage%2Cmarket_code%2Cbirthday"
...
perform_batch_update_for_subscribes("226606510417", 200, 1)
